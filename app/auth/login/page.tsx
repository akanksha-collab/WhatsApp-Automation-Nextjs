        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/auth/register" className="text-whatsapp-teal hover:text-whatsapp-dark-teal font-medium">
                Create one
              </Link>
            </p>
          </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-whatsapp-beige flex items-center justify-center">
